...
4. The installer automatically starts the app after setup. You can relaunch it
   later by running one of the created launchers.
...
- Copies the archive into your selected directory, mirrors the freshly built
  ...
  is used to start the app automatically at the end of installation.
