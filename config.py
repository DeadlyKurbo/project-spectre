...
LEAD_ARCHIVIST_MENU_CHANNEL_ID = int(
    os.getenv("LEAD_ARCHIVIST_MENU_CHANNEL_ID", "1405751160819683348")
)
ARCHIVIST_MENU_CHANNEL_ID = int(
    os.getenv("ARCHIVIST_MENU_CHANNEL_ID", "1408250381972013191")
)
