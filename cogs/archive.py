...
class ArchiveView(nextcord.ui.View):
    def __init__(self):
        ...
        self.add_item(nextcord.ui.Button(style=nextcord.ButtonStyle.secondary, label="Mission Logs",    custom_id=PERSISTENT_IDS["open_mission"]))
        self.add_item(nextcord.ui.Button(style=nextcord.ButtonStyle.success,   label="Intelligence",    custom_id=PERSISTENT_IDS["open_intel"]))
