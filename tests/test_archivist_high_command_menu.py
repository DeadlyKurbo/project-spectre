...
def test_archivist_high_command_menu(monkeypatch):
    ...
    assert isinstance(inter.response.kwargs['view'], arch.HighCommandConsoleView)
    assert inter.response.kwargs['embed'].title == main.HIGH_COMMAND_TITLE
